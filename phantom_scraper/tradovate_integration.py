        ...
        try:
            ...
            if multi_brackets:
                ...
                for i, leg in enumerate(multi_brackets):
                    ...
                    # NOTE: Native break-even NOT supported in Tradovate brackets
                    # ("Stop and Stop/Limit breakeven supported only") — handled by safety-net monitor in recorder_service.py
